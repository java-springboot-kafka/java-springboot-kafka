...
""!==n?a.forEach((function(e,r){c=s.indexOf(e),u=n.indexOf(e),c<0&&u<0?t=!1:(u<0&&(u=0),0===r&&(h=u))})):t=!1,t){r+="<a href='"+o+"' class='list-group-item list-group-item-action font-weight-bolder search-list-title'>"+l+"</a>";var d=i;if(h>=0){
